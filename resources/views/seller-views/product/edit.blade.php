                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3" id="digital_file_ready_show">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p class="h-100 mt-5">
                                                    <a href="{{asset("storage/app/product/digital-product/$product->digital_file_ready")}}" target="_blank">{{ $product->digital_file_ready }}</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row g-2" id="meta_img">
                                            <div class="col-sm-6 col-md-12 col-lg-6">
                                                <img class="w-100" height="auto"
                                                        ...
                                                        src="{{asset("storage/app/product/meta")}}/{{$product['meta_image']}}"
                                                        alt="Meta image">
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-6 col-lg-6 col-xl-6">
                                                        <div class="card mt-1">
                                                            <div class="card-body">
                                                                <img class="w-100"
                                                                     onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                                     src="{{asset("storage/app/product/$photo")}}"
                                                                     alt="Product image">
                                                            ...
                                                            <div class="col-6 col-lg-6 col-xl-6">
                                                                <div class="card mt-1">
                                                                    <div class="card-body">
                                                                        <img class="w-100" height="auto"
                                                                             onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                                             src="{{asset("storage/app/product/$photo->image_name")}}"
                                                                             alt="Product image">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="rounded overflow-hidden">
                                                        <img class="w-100" onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" src="{{asset("storage/app/product/thumbnail")}}/{{$product['thumbnail']}}" alt="Product image">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-6 col-md-6">
                                <div class="card">
                                    ...
                                    <i class="tio-done"></i>
                                        ...
                                        <img class="w-100" height="auto"
                                             onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                             src="{{asset('storage/app/product/`+image_name+`')}}"
                                             alt="Product image">
            ...
            $.each(colors, function(key, value){
                ...
                if(in_array_image === -1) {
                    let html = ` <div class='col-6 col-md-6'> <label style='border: 2px dashed #ddd; border-radius: 3px; cursor: pointer; text-align: center; overflow: hidden; padding: 5px; margin-top: 5px; margin-bottom : 5px; position : relative; display: flex; align-items: center; margin: auto; justify-content: center; flex-direction: column;'>
                            ...
                            <img src="{{ asset('assets/back-end/img/400x400/img2.jpg') }}" style="object-fit: cover;aspect-ratio:1"  alt="img">
                          </label> </div>`;
