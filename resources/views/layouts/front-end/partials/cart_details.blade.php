                    ...
                    <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table __cart-table">
                        <thead class="thead-light">
                            <tr class="">
                                ...
                                @if ( $shipping_type != 'order_wise'&&$shipping_type != 'city_wise')
                        ...
                        @foreach($group as $cart_key=>$cartItem)
                            <tr>
                                ...
                                @if($physical_product && $shippingMethod=='sellerwise_shipping' && ($shipping_type == 'order_wise'||$shipping_type == 'city_wise'))
...
@if($shippingMethod=='inhouse_shipping')
        <?php
            ...
            $shipping_type = isset($admin_shipping) == true ? $admin_shipping->shipping_type : 'order_wise';
        ?>
    @if (($shipping_type == 'order_wise'|| $shipping_type == 'city_wise')&& $physical_product)
