                                                        ...
                                                        <div class="modal-body">
                                                            @if($detail->digital_file_after_sell)
                                                                <div class="mb-4">
                                                                    ...
                                                                    <a href="{{ asset('storage/app/product/digital-product/'.$detail->digital_file_after_sell) }}"
                        ...
                        <div class="media">
                            @if($order->seller_is == 'admin')
                                <div class="mr-3">
                                    <img class="avatar rounded avatar-70" onerror="this.src='https://6valley.6amtech.com/assets/front-end/img/image-place-holder.png'"
                                         src="{{asset("storage/app/company/$company_web_logo")}}" alt="">
                                </div>
                            ...
                            @else
                                @if(!empty($order->seller->shop))
                                    <div class="mr-3">
                                        <img class="avatar rounded avatar-70" onerror="this.src='https://6valley.6amtech.com/assets/front-end/img/image-place-holder.png'"
                                             src="{{asset('storage/app/shop')}}/{{$order->seller->shop->image}}" alt="">
                                    </div>
                                    <div class="media-body d-flex flex-column gap-2">
    ...
    <script>
        ...
        function initializegLocationMap() {
            ...
            google.maps.event.addListener(marker, 'click', (function (marker) {
                return function () {
                    infowindow.setContent("<div class='float-left'><img class='__inline-5' src='{{asset('storage/app/profile/')}}{{$order->customer->image??""}}'></div><div class='float-right __p-10'><b>{{$order->customer->f_name??""}} {{$order->customer->l_name??""}}</b><br/>{{$shipping_address->address??""}}</div>");
