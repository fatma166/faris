            ...
            <div class="col-md-6">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        @php($config=\App\CPU\Helpers::get_business_settings('tamara'))
                        <form action="{{route('admin.business-settings.payment-method.update',['tamara'])}}"
                              method="post">
                            @csrf
                            @if(isset($config))
                                <center class="mb-3">
                                    <img src="{{asset('/assets/back-end/img/tamara.png')}}" alt="">
                                </center>

                                <div class="d-flex flex-wrap gap-2 justify-content-between mb-3">
                                    <h5 class="text-uppercase">{{\App\CPU\translate('Tamara')}}</h5>
                                ...
                                <div class="form-group">
                                    <label class="title-color d-flex">{{\App\CPU\translate('Tamara')}}{{\App\CPU\translate('notification')}} {{\App\CPU\translate('token')}} </label>
                                    <input type="text" class="form-control" name="tamara_notification_token"
                                           value="{{env('APP_MODE')=='demo'?'':$config['tamara_notification_token']}}">
                                </div>
                                <div class="mt-3 d-flex flex-wrap justify-content-end gap-10">
                                    <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                            onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}"
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        @php($config=\App\CPU\Helpers::get_business_settings('tabby'))
                        <form action="{{route('admin.business-settings.payment-method.update',['tabby'])}}"
                              method="post">
                            @csrf
                            @if(isset($config))
                                <center class="mb-3">
                                    <img src="{{asset('/assets/back-end/img/tabby.png')}}" alt="">
                                </center>

                                <div class="d-flex flex-wrap gap-2 justify-content-between mb-3">
                                    <h5 class="text-uppercase">{{\App\CPU\translate('Tabby')}}</h5>
                                ...
                                <div class="form-group">
                                    <label class="title-color d-flex">{{\App\CPU\translate('Tabby')}} {{\App\CPU\translate('api')}}{{\App\CPU\translate('key')}}</label>
                                    <input type="text" class="form-control" name="tabby_api_key"
                                           value="{{env('APP_MODE')=='demo'?'':$config['tabby_api_key']}}">
                                </div>
