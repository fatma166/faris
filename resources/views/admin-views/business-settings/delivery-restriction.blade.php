                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form action="{{ route('admin.business-settings.delivery-restriction.add-zip-code') }}"
                                    ...
                                    <label class="title-color d-flex"> {{\App\CPU\translate('city')}} </label>
                                    <input type="text" class="form-control" name="city"
                                           placeholder="{{ \App\CPU\translate('enter_city') }}"
                                           data-role="tagsinput" required>
                                    ...
                                    <select
                                        class="js-example-basic-multiple js-states js-example-responsive form-control"
                                        name="country_code" id="choice_attributes" >
                                        @foreach($countries as $country)
                                            <option value="{{ $country['code'] }}" {{ in_array($country['code'], $stored_country_code) ? 'disabled' : '' }}  @if($country['code']=='SA') selected="selected"@endif>
                                                {{ $country['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="table-responsive">
                                    <table id="datatable"
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">{{\App\CPU\translate('country_code')}}</th>
                                            <th class="text-center">{{\App\CPU\translate('action')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @forelse($stored_zip as $k=>$zip)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $zip->city }}</td>
                                                <td class="text-center">{{ $zip->country_code }}</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <a class="btn btn-outline-danger btn-sm square-btn"
                                                           href="javascript:"
