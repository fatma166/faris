            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.business-settings.shipping-method.update',[$method['id']])}}"
                        ...
                        @if(!empty($method['city_id'])&&$method['city_id']!=null&&$method['city_id']!='')
                        <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="city_id">
                                        @foreach($cities as $city)
                                            <option value="{{$city['id']}}"  @if($method['city_id']==$city['id']) selected="selected"@endif>{{$city['city']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
