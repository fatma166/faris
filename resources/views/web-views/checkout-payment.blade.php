...
@push('css_or_js')
    ...
    <script src="https://cdn.tamara.co/sdk/tamara-sdk.js"></script>
    {{--stripe--}}
@endpush
                                ...
                                <div class="col-sm-6">
                                    <div class="card cursor-pointer">
                                        <div class="card-body pt-2 __h-100px">
                                            <form method="POST" action="{{ route('tamara-create-payment') }}">
                                                {{ csrf_field() }}
                                                <!--<button onclick="openTamaraPayment()">Pay with Tamara</button>-->
                                                <button class="btn btn-block click-if-alone" type="submit">
                                                    <img width="200"
                                                         src="{{asset('assets/back-end/img/tamara.png')}}"/>
                                                </button>
                                            </form>
                                        </div>
                                    </div>
...
@push('script')
    ...
    <script type="text/javascript">
       /* // Set up Tamara SDK
        ...
        // Open Tamara payment gateway
        function openTamaraPayment() {
            alert("klkl");
            Tamara.pay(paymentOptions)
                .then(function (response) {
