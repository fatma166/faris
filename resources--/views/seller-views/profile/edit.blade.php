            ...
            <div class="col-lg-9">
                ...
                <!-- Card -->
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        @php($shop_banners = $shop_banner ? asset('storage/app/shop/banner/'.$shop_banner) : 'https://images.pexels.com/photos/866398/pexels-photo-866398.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')
