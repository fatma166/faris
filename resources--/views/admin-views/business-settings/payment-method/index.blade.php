                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.business-settings.payment-method.update',['tabby'])}}"
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group">
                                    <label class="title-color d-flex">{{\App\CPU\translate('Tabby')}} {{\App\CPU\translate('Client')}}{{\App\CPU\translate('ID')}}</label>
                                    <input type="text" class="form-control" name="tamara_client_id"
                                           value="{{env('APP_MODE')=='demo'?'':$config['tabby_client_id']}}">
                                </div>
                                <div class="form-group">
                                    <label class="title-color d-flex">{{\App\CPU\translate('Tabby')}} {{\App\CPU\translate('Secret')}} </label>
                                    <input type="text" class="form-control" name="tamara_secret"
                                           value="{{env('APP_MODE')=='demo'?'':$config['tabby_secret']}}">
                                </div>
                                <div class="mt-3 d-flex flex-wrap justify-content-end gap-10">
                                    <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                            onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}"
