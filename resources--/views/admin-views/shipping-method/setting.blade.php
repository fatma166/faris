...
<div class="content container-fluid">
    ...
    <div class="row gy-3" >
                ...
                <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <div class="mb-2">
                        ...
                        <select class="form-control text-capitalize w-100" name="shippingCategory" onchange="shipping_type(this.value);">
                            ...
                            <option value="city_wise" {{$shippingType=='city_wise'?'selected':'' }} >{{\App\CPU\translate('city_wise')}} </option>
                            ...
                            <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" cellspacing="0"
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                      ...
                                      <!--  <th class="text-center">{{\App\CPU\translate('city')}}</th>-->
                    ...
                    <div class="card">
                        <div class="px-3 py-4">
                            <div class="row justify-content-between align-items-center flex-grow-1">
                                <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                                    <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                        {{\App\CPU\translate('city_wise_shipping_method')}}
                                        <span class="badge badge-soft-dark radius-50 fz-12">{{ $shipping_methods_city_wize->count() }}</span>
                                    </h5>
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive pb-3">
                            <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" cellspacing="0"
                                ...
                                <tbody>
                                @foreach($shipping_methods_city_wize as $k=>$method)
                                    <tr>
                                        <th>{{$k+1}}</th>
                                        <td>{{$method['title']}}</td>
                                        <td>
        ...
        <div class="col-12" id="city_wise">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mb-0 text-capitalize">{{\App\CPU\translate('add_city_wise_shipping')}}</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{route('admin.business-settings.shipping-method.add')}}"
                                style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                method="post">
                                @csrf
                                <input type="hidden" value="city_wise" name="method_"/>
                                <div class="form-group">
                                    <div class="row justify-content-center">
                                        <div class="col-md-12">
                                            <label class="title-color" for="title">{{\App\CPU\translate('title')}}</label>
                                ...
                                <div class="form-group">
                                    <div class="row justify-content-center">
                                        <div class="col-md-12">
                                            <label class="title-color" for="cost">{{\App\CPU\translate('city')}}</label>
                                           <select name="city_id">
...
<script>
    $( document ).ready(function() {
        ...
        } else if(shipping_type==='city_wise'){
