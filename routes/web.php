...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::group(['middleware'=>['customer']], function () {
        ...
        Route::get('get-country-cities', 'WebController@get_country_cities')->name('get-country-cities');
        Route::get('add-order-date', 'WebController@add_order_date')->name('add-order-date');
        Route::get('change_get_shipping_cost', 'WebController@change_get_shipping_cost')->name('change-get-shipping-cost');
...
//tamara
Route::post('/tamara/create', 'TamaraController@create')->name('tamara-create-payment');
Route::post('/tamara/callback', 'TamaraController@callback')->name('tamara-response');
