...
class ConfigController extends Controller
{
    public function configuration()
    {
        ...
        $company_logo = asset("storage/app/company/").'/'.BusinessSetting::where(['type'=>'company_web_logo'])->first()->value;
        ...
        return response()->json([
            ...
            'base_urls' => [
                ...
                'digital_product_url' => asset('storage/app/product/digital-product'),
                ...
                'seller_image_url' => asset('storage/app/seller'),
